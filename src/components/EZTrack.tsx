...
export default function EZTrackSnapSteps() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      description:
        "EZTrack generates interpretable spatio-temporal heatmaps and summary overlays to highlight regions of potential surgical interest.",
      image:
  ...
  // Footer is included inside final CTA (not its own snap section)
  const totalSections = 1 + steps.length + 1; // = 5
  ...
  return (
    <main className="text-black bg-[#fbfbf8]">
      ...
      >
        ...
        {/* =========================
            FINAL CTA + Footer INSIDE (no extra snap)
           ========================= */}
        <section
